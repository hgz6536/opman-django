...
from devop.views.gitman import Setting, ListProjects, AddToken, UploadProject, Reset, GitLog, ProSetting, UploadApply
urlpatterns = [
    ...
    url(r'^upload/apply/(?P<ID>\d+)/(?P<Pname>.+)&(?P<Url>.+)$', UploadApply, name='uploadapplyurl'),
